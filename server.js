...
var DbSchema = new mongoose.Schema({
    name: {type: String, minlength: [3, "Name needs to be at least 3 characters"]},
    type: {type: String, minlength: [3, "Type needs to be at least 3 characters"]},
    description: {type: String, minlength: [3, "Description needs to be at least 3 characters"]},
    skills: [{type: String}],
